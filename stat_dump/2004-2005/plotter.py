...
name_list = ['worst_BH-_testlauf_exp(1).csv','worst_BH+_testlauf_exp(1).csv','worst_RNG_testlauf_exp(1).csv','worst_Poly_exp(2).csv','worst_rSVM_exp_w1000(2).csv','worst_NLSVMw1000.csv','worst_RRL_exp(1).csv','worst_nSVM_exp(1).csv','worst_MLP_l4m30w1000_exp(1).csv']
axis_labels = ['Seller','Buyer','RandomTrader','Polynomialregressor','Recurrent SVM','Nonlinear SVM','Recurrent NN','Naive SVM','MLP']
