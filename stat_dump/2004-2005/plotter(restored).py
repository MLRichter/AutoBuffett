...
name_list = ['best_BH-_testlauf_exp(1).csv','best_BH+_testlauf_exp(1).csv','best_RNG_testlauf_exp(1).csv','best_Poly_exp(1).csv','best_RRL_exp(1).csv','best_nSVM_exp(1).csv','best_rSVM_exp_w1000(2).csv','best_NLSVMw1000.csv','best_MLP_l4m30w1000_exp(1).csv']
axis_labels = ['Seller','Buyer','RandomTrader','Polynomialregressor','Recurrent NN','Naive SVM','Recurrent SVM','Nonlinear SVM','MLP']
